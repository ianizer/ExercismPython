...
def clean_up(combined_record_group: tuple) -> str:
    ...
    for record in combined_record_group:
        # Remove string-only coordinate (like '1F') by skipping second value in tuple.
        cleaned_record = record[0:1] + record[2:]

        cleaned_string += str(cleaned_record) + "\n"

    # It's intended to have a trailing '\n'
